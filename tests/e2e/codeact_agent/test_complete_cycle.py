...
class TestCompleteCycle:
    ...
    def mock_prompt_manager(self):
        ...
        # Configure the mock to return a valid template when set_system_prompt is called
    ...
    def test_complete_development_cycle(self, agent, mock_llm, mock_prompt_manager):
        ...
        with patch.object(agent, 'llm', mock_llm):
            ...
            responses = [
                "Let's start planning the development",  # Planning
                'We are moving to development',  # Transition to execution
                'Executing the development steps',  # Execution
                'Development complete',  # Transition to completion
                'Finalizing the development',  # Completion
            ]
